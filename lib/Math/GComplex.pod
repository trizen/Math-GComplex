...
Math::GComplex provides a generic interface to complex number operations, accepting any type of number as a component of a complex number, including numerical objects provided by other mathematical libraries, such as L<Math::AnyNum>.
...
This section describes the functions and methods provided by this module.
...
Copyright 2017 Daniel "Trizen" Șuteu.
