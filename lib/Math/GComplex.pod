...
Math::GComplex provides a generic interface to complex number operations, accepting any type of number as a component of a complex number, including native Perl numbers or numerical objects provided by other mathematical libraries, such as L<Math::AnyNum>.
...
Due to its simple and elegant design, this module is between 2x up to 8x faster than L<Math::Complex>.
